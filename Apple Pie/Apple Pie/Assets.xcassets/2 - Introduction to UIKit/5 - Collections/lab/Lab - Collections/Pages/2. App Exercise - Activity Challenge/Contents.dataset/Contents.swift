 ...
 */
var runningChallenges:[String] = ["Run 2 miles", "Run 1 mile in 6 minutes"]
var walkingChallenges:[String] = ["Walk 5 miles", "Walk for 1 hour"]
 ...
 */
var committedChallenges:[String] = ["Walk 3 miles"]
...
if committedChallenges.isEmpty {
    ...
    print("Your chosen challenge is \(committedChallenges[0])")
} else {
    print("You've committed to several challenges")
}
