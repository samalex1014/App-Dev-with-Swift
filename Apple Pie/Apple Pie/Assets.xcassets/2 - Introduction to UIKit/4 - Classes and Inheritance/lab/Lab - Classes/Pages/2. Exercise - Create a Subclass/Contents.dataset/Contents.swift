...
class Fighter : Spaceship {
    ...
    func fire() {
        if(remainingFirePower >= 1) {
            ...
            print("Sorry you have no more firepower")
        }
    }
}
...
print("Starting position: \(destroyer.position)")
destroyer.moveRight()
print("Ending position: \(destroyer.position)")
/*:
 ...
 */
print("Well this doesn't work because falcon is an instance of a super class on the inheritance tree higher than when weapon was introduced")
