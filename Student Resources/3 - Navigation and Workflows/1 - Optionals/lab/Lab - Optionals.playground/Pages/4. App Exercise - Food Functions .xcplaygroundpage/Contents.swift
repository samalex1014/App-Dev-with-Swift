...
func whatDidIEat(_ meal: String) -> Meal? {
    var result: Meal? = nil
    
    if let whatIAte = meals[meal] {
        result = whatIAte
    }
    return result
}

print(whatDidIEat("Breakfast"))
print(whatDidIEat("Lunch"))
 ...
 */
if let meals: [String: Any] = UserDefaults.standard.dictionary(forKey: "mealLog") {
    print("It's been saved")
} else {
    print("Your data is gone")
}
