...
//print("The value of foo is \(foo)")
//foo is not accessible outside of the for loop
...
//x is defined prior to the for loop, and the x in the foor loop is inaccessible
/*:
...
greeting(greeting: nil, name: "Sam")
/*:
