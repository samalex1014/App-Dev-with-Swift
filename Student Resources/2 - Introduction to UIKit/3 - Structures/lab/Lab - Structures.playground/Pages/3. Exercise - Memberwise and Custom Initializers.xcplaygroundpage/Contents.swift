...
print("Latitude is \(somePlace.latitude) and longitude is \(somePlace.longitude)")
...
let favoriteBook = Book(title: "East of Eden", author: "John Steinbeck", pages: 324, price: 12.54)
...
print("My height is \(myHeight.heightInCentimeters) centimeters")
