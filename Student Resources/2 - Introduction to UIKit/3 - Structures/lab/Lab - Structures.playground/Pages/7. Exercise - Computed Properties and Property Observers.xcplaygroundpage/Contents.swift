...
var carpet = Rectangle(width: 32, height: 56)
print(carpet.area)
/*:
...
var mine = Height(heightInInches: 68.9)
print(mine.heightInCentimeters)
mine.heightInCentimeters = 1720

print(mine.heightInInches)
