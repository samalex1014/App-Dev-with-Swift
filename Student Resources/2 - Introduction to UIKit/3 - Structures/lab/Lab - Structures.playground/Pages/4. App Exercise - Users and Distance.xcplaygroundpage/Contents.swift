 ...
 */
var sam = User(name: "Sam", age: 23, height: 69, weight: 150, activityLevel: 4)

print("The user's name is \(sam.name), age \(sam.age), height \(sam.height), weight \(sam.weight), and activity level \(sam.activityLevel)")
 ...
 */
struct Distance {
    static let metersInAFoot = 3.28084
    ...
    init(meters: Double) {
        self.meters = meters
        self.feet = meters * Distance.metersInAFoot
    }
    
    init(feet: Double) {
        self.meters = feet / Distance.metersInAFoot
        self.feet = feet
    }
}
 ...
 */
var example = Distance(feet: 32000000)

print(example.meters)
